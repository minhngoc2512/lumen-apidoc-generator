...
namespace MinhNgoc\ApiDoc\Commands;
...
use MinhNgoc\ApiDoc\Documentarian\Documentarian;
use MinhNgoc\ApiDoc\Postman\CollectionWriter;
use MinhNgoc\ApiDoc\Generators\DingoGenerator;
use MinhNgoc\ApiDoc\Generators\LaravelGenerator;
use MinhNgoc\ApiDoc\Generators\AbstractGenerator;
...
class GenerateDocumentation extends Command
{
    ...
    {
        if(strpos($this->option('output'),'public')!==0){
